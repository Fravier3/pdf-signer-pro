...
const DrawSignature = (() => {
  ...
  function resizeCanvasToDisplaySize() {
    ...
    // Si el contenedor aún está oculto (display:none) su tamaño es 0x0;
    // en ese caso no tocamos el canvas y esperamos a que se vuelva a
    // llamar esta función cuando la pantalla ya sea visible.
    if (w === 0 || h === 0) return;
